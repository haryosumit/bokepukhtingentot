...
export default async function Video({ params }: PageProps) {
    ...
    if (data.status !== 200) {
        ...
        url: `https://bokepukhtingentot.pages.dev/v/${file.file_code}`,
        ...
        interactionStatistic: {
            ...
            interactionType: {
                '@type': `ReadAction`,
                target: `https://bokepukhtingentot.pages.dev/v/${file.file_code}`
            }  
        }
        }
